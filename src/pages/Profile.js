          ...
          <section className="profile-card" aria-label="Personal information">
            ...
            <div className="info-grid">
              <div className="info-field">
                ...
                {isEditing ? (
                  <input id="profile-name" className="profile-input" value={draft.name}
              ...
              <div className="info-field">
                ...
                {isEditing ? (
                  <input id="profile-email" className="profile-input" type="email" value={draft.email}
              ...
              <div className="info-field">
                ...
                {isEditing ? (
                  <select id="profile-grade" className="profile-input" value={draft.gradeLevel}
              ...
              <div className="info-field">
                ...
                {isEditing ? (
                  <select id="profile-strand" className="profile-input" value={draft.strand}
                ...
                {allInterests.map((interest) => {
                  ...
                  return (
                    <button key={interest} type="button"
                      ...
                      aria-pressed={selected} onClick={() => toggleInterest(interest)}>
                      {selected && "✓ "}{interest}
                    </button>
                  );
                })}
